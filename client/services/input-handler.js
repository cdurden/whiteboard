angular.module("whiteboard.services.inputhandler", []).factory("InputHandler", [
    "BoardData",
    "Snap",
    "EventHandler",
    "Broadcast",
    "Visualizer",
    "Zoom",
    function (BoardData, Snap, EventHandler, Broadcast, Visualizer, Zoom) {
        var toggleAttrs = {};
        ...
        function getClosestElementByArea(ev) {
            ...
            paper.forEach(function (el) {
                ...
                if (
                    !(el.type === "set") &&
                    Raphael.isBBoxIntersect(elBBox, bbox)
                ) {
                    var elBBoxCenter = {
        ...
        actions.move = {
            ...
            mouseUp: function (ev) {
                ...
                EventHandler.finishMovingShape(
                    editorShape.myid,
                    editorShape.socketId
                );
        ...
        actions.copy = {
            mouseDown: function (ev) {
                ...
                if (shape.tool.name === "path") {
                    ...
                    var parsedPathArray = Raphael.parsePathString(
                        shape.pathDProps
                    );
            ...
            mouseDown: function (ev) {
                ...
                document.onkeypress = function (ev) {
                    ...
                    if (ev.keyCode === 13) {
                        ...
                        editorShape.tool.colors.fill =
                            editorShape.trueColors.fill;
                        editorShape.tool.colors.stroke =
                            editorShape.trueColors.stroke;
                        editorShape.attr({
                        ...
                        if (editorShape) {
                            editorShape.attr(
                                ...
                                editorShape
                                    ...
                                    .slice(
                                        0,
                                        editorShape.attr("text").length - 1
                                    )
                            );
                            currentTool.text = editorShape.attr("text");
                            EventHandler.editShape(
        ...
        function touchStart(ev) {
            mouseDown(ev.originalEvent.touches[0]);
        }
        function touchMove(ev) {
            mouseMove(ev.originalEvent.touches[0]);
        }
        function touchEnd(ev) {
            mouseUp(ev.originalEvent.touches[0]);
        }
