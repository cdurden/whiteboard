angular.module("whiteboard.services.shapeeditor", []).factory("ShapeEditor", [
    "BoardData",
    "Snap",
    "ShapeManipulation",
    function (BoardData, Snap, ShapeManipulation) {
        ...
        function finishShape(id, socketId, tool) {
            ...
            if (shape.pathDProps !== undefined) {
                ...
                var lastPoint = path
                    ...
                    .map(Number);
                if (
                    lastPoint[0] === shape.initX &&
                    lastPoint[1] === shape.initY
                ) {
