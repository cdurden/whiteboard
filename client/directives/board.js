angular.module("whiteboard").directive("wbBoard", [
    "BoardData",
    "Broadcast",
    "Receive",
    "LeapMotion",
    function (BoardData) {
        return {
            ...
            link: function (scope, element, attrs, ctrls) {
                ...
                BoardData.getCanvas().bind(
                    "mousedown mouseup mousemove dblclick touchstart touchend touchmove",
                    boardCtrl.handleEvent
                );
